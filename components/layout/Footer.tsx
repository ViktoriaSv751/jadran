...
export default function Footer() {
  ...
  return (
    <footer className="mt-2 bg-white pb-[calc(6.5rem+env(safe-area-inset-bottom))] lg:pb-0">
      {/* Ország-katalógus. Kettős haszna van: a látogató egy kattintással eljut
          bármelyik piacra, a keresők pedig MINDEN oldalról belső hivatkozást
          látnak a 12 ország-landingre és a tudástárra — ez az egyik legerősebb
          rangsorolási tényező (ugyanezt csinálja az Airbnb és a Booking is).
