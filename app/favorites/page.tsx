...
function FavoritesInner() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      {/* Szűrő-sáv — mint a hirdetés-listán: mód-váltó, kereső, rendezés. */}
      {saved.length > 0 && (
        <div className="mb-6 flex flex-col gap-3">
          <div className="inline-flex w-fit rounded-full border border-ink-200 bg-white p-1 shadow-soft">
            {([
